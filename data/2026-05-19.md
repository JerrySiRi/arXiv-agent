...
### [121] [Factorized Latent Dynamics for Video JEPA: An Empirical Study of Auxiliary Objectives](https://arxiv.org/abs/2605.17165)
*Santosh Premi*
...
### [131] [CodeBind: Decoupled Representation Learning for Multimodal Alignment with Unified Compositional Codebook](https://arxiv.org/abs/2605.18257)
...
### [132] [LISA: Language-guided Interference-aware Spatial-Frequency Attention for Driver Gaze Estimation](https://arxiv.org/abs/2605.17287)
...
### [133] [HierEdit: Region-Aware Hierarchical Diffusion for Efficient High-Resolution Editing](https://arxiv.org/abs/2605.17294)
...
### [134] [What is Holding Back Latent Visual Reasoning?](https://arxiv.org/abs/2605.18445)
...
### [135] [LongDPM: Overlap-Aware 4D Reconstruction from Long Monocular Videos](https://arxiv.org/abs/2605.17303)
...
### [136] [StyleText: A Large-Scale Dataset and Benchmark for Stylized Scene Text Inpainting](https://arxiv.org/abs/2605.17309)
...
### [137] [Vision-OPD: Learning to See Fine Details for Multimodal LLMs via On-Policy Self-Distillation](https://arxiv.org/abs/2605.18740)
...
### [139] [ESI-Bench: Towards Embodied Spatial Intelligence that Closes the Perception-Action Loop](https://arxiv.org/abs/2605.18746)
...
### [407] [Proof-Carrying Certificates for LLM Pipelines: A Trust-Boundary Architecture](https://arxiv.org/abs/2605.16407)
*George Koomullil*
...
### [408] [Orthologic for SAT Solving](https://arxiv.org/abs/2605.16421)
...
### [409] [Certificate-Aware Property-Directed Reachability](https://arxiv.org/abs/2605.16472)
...
### [411] [On Variable-Bounded Non-Linear Expansions of Presburger Arithmetic](https://arxiv.org/abs/2605.16985)
...
### [412] [A unification of graded and substructural logics](https://arxiv.org/abs/2605.17112)
...
### [413] [A Proof-Theoretic Study of Modal Logic](https://arxiv.org/abs/2605.18043)
*Hirohiko Kushida*
...
Abstract: This paper proposes a basic proof theoretic framework for major modal logics: {\sf S5} and some of its subsystems. The framework is based on a version of hypersequent calculus, and the basic modal systems we handle here are the system {\sf K} and its standard extensions with combinations of axioms: $T, D, 4, B, 5$. First we propose a reasonable explanation of how the standard sequent and hypersequent calculi for some of those modal logics such as {\sf K, T, D, S4, S5} emerge on the basis of the framework. Then, by a syntactic method, we prove the cut-elimination theorem for the modal logics except for the modal logics {\sf KB, KDB, KTB}. Quantified versions of the systems of the framework are also discussed.

</details>


### [414] [Decidability of MSO Reparameterization over Countable Chains](https://arxiv.org/abs/2605.18248)
...
Abstract: Interpretations are a fundamental tool in mathematical logic, allowing structures to be encoded within other structures via logical definitions. We study $\MSO$ \emph{multidimensional point interpretations}, where elements of an interpreted structure are represented by tuples of elements of the host structure, and address the problem of simplifying such interpretations by reducing their representation dimension.
  To formalize simplification, we use the notion of \emph{reparameterization}. Our main result shows that, over the class of countable labelled linear orders, it is decidable whether a given $\MSO$ formula admits a $d$-dimensional reparameterization. As a consequence, every interpretation whose domain admits such a reparameterization is equivalent to a $d$-dimensional point interpretation.

</details>


### [415] [Compositionality in Coalgebraic Trace Semantics](https://arxiv.org/abs/2605.18285)
...
### [419] [Wiring the Pi-calculus to Denotational Semantics](https://arxiv.org/abs/2605.18496)
...
### [420] [On Generalized Performance Evaluation and Generalized Controller Synthesis](https://arxiv.org/abs/2605.18688)
*Zining Cao*
...
### [421] [GRASP: Graph Agentic Search over Propositions for Multi-hop Question Answering](https://arxiv.org/abs/2605.16598)
...
### [422] [Dynamic Deployment of Mobile Charging Trucks During Natural Disaster Evacuation: An Offline-to-Online Framework](https://arxiv.org/abs/2605.16784)
...
### [423] [Lifelong LaCAM with Local Guidance for Lifelong MAPF](https://arxiv.org/abs/2605.16855)
...
### [424] [PyraVid: Hierarchical Multimodal Memory for Long-Horizon Video Reasoning](https://arxiv.org/abs/2605.17065)
...
### [425] [Multi-LLM Systems Exhibit Robust Semantic Collapse](https://arxiv.org/abs/2605.17193)
...
### [426] [Bimodal Synchronization Performance: Why Noise and Sparse Connectivity Can Improve Collective Timing](https://arxiv.org/abs/2605.17206)
...
### [427] [Human-Flow Digital Twin for Predicting the Effects of Mobility Introduction on Visitor Circulation](https://arxiv.org/abs/2605.17426)
...
### [428] [Reservation Based Smart Parking Management](https://arxiv.org/abs/2605.17650)
...
### [429] [The Dynamics of Policy Gradient in Social Dilemmas with Partner Selection](https://arxiv.org/abs/2605.18185)
...
### [430] [Evolutionary Extreme Learning Machine of ab-initio Energy Landscapes for Crystal Structure Prediction using Manta Ray Optimization with Levy Flight](https://arxiv.org/abs/2605.17148)
*Adrian Rubio-Solis*
...
### [431] [Adaptive Stochastic Natural Gradient Method for Safe Optimization on Binary Space](https://arxiv.org/abs/2605.17925)
...
### [432] [Spiker-LL: An Energy-Efficient FPGA Accelerator Enabling Adaptive Local Learning in Spiking Neural Networks](https://arxiv.org/abs/2605.18003)
...
### [433] [Mapping the Fitness Landscape: A Structure-Guided Approach to Multi-Modal Optimization](https://arxiv.org/abs/2605.18351)
*Meng Xiang,Pei Yan*
...
### [434] [When Fireflies Cluster; Enhancing Automatic Clustering via Centroid-Guided Firefly Optimization](https://arxiv.org/abs/2605.18460)
...
### [435] [ANNEAL: Adapting LLM Agents via Governed Symbolic Patch Learning](https://arxiv.org/abs/2605.16309)
...
### [436] [NeuroMAS: Multi-Agent Systems as Neural Networks with Joint Reinforcement Learning](https://arxiv.org/abs/2605.16757)
...
### [437] [Reliability and Effectiveness of Autonomous AI Agents in Supply Chain Management](https://arxiv.org/abs/2605.17036)
...
### [438] [MADP: A Multi-Agent Pipeline for Sustainable Document Processing with Human-in-the-Loop](https://arxiv.org/abs/2605.17159)
...
### [439] [Responsible Agentic AI Requires Explicit Provenance](https://arxiv.org/abs/2605.17169)
...
### [440] [MetaCogAgent: A Metacognitive Multi-Agent LLM Framework with Self-Aware Task Delegation](https://arxiv.org/abs/2605.17292)
...
### [441] [Heterogeneous Information-Bottleneck Coordination Graphs for Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2605.17393)
...
### [442] [LLM-Guided Communication for Cooperative Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2605.18077)
...
### [443] [Recall Isn't Enough: Bounding Commitments in Personalized Language Systems](https://arxiv.org/abs/2605.16712)
...
### [444] [How do Humans Process AI-generated Hallucination Contents: a Neuroimaging Study](https://arxiv.org/abs/2605.16953)
...
### [445] [RAGA: Reading-And-Graph-building-Agent for Autonomous Knowledge Graph Construction and Retrieval-Augmented Generation](https://arxiv.org/abs/2605.17072)
...
### [446] [CyberCorrect: A Cybernetic Framework for Closed-Loop Self-Correction in Large Language Models](https://arxiv.org/abs/2605.17305)
...
### [447] [HyperPersona: A Multi-Level Hypergraph Framework for Text-Based Automatic Personality Prediction](https://arxiv.org/abs/2605.17355)
...
### [448] [RAG-based EEG-to-Text Translation Using Deep Learning and LLMs](https://arxiv.org/abs/2605.17503)
...
### [449] [Generalization or Memorization? Brittleness Testing for Chess-Trained Language Models](https://arxiv.org/abs/2605.17565)
*Ethan Tang*
...
### [450] [Causal Intervention-Based Memory Selection for Long-Horizon LLM Agents](https://arxiv.org/abs/2605.17641)
...
### [451] [Entropy-Gradient Inversion: Moving Toward Internal Mechanism of Large Reasoning Models](https://arxiv.org/abs/2605.17770)
...
### [452] [Remembering More, Risking More: Longitudinal Safety Risks in Memory-Equipped LLM Agents](https://arxiv.org/abs/2605.17830)
...
### [453] [Agentic Chunking and Bayesian De-chunking of AI Generated Fuzzy Cognitive Maps: A Model of the Thucydides Trap](https://arxiv.org/abs/2605.17903)
...
### [454] [TRACE: Trajectory Correction from Cross-layer Evidence for Hallucination Reduction](https://arxiv.org/abs/2605.18163)
*Tej Sanibh Ranade*
...
### [455] [Scalable Environments Drive Generalizable Agents](https://arxiv.org/abs/2605.18181)
...
### [456] [SD-Search: On-Policy Hindsight Self-Distillation for Search-Augmented Reasoning](https://arxiv.org/abs/2605.18299)
...
### [457] [GIM: Evaluating models via tasks that integrate multiple cognitive domains](https://arxiv.org/abs/2605.18663)
...
### [458] [Sustainable Intelligence for the Wild: Democratizing Ecological Monitoring via Knowledge-Adaptive Edge Expert Agents](https://arxiv.org/abs/2605.16671)
...
### [459] [Is VLA Reasoning Faithful? Probing Safety of Chain-of-Causation](https://arxiv.org/abs/2605.17268)
...
### [460] [SVFSearch: A Multimodal Knowledge-Intensive Benchmark for Short-Video Frame Search in the Gaming Vertical Domain](https://arxiv.org/abs/2605.17946)
...
### [461] [TaskGround: Structured Executable Task Inference for Full-Scene Household Reasoning](https://arxiv.org/abs/2605.18109)
...
### [462] [Beyond the Cartesian Illusion: Testing Two-Stage Multi-Modal Theory of Mind under Perceptual Bottlenecks](https://arxiv.org/abs/2605.18194)
